...
/// <summary>
/// 鱼缸装饰皮肤编辑器（ID范围：8001-8999）
/// </summary>
public class FishTankDecorationDataEditor : EditorWindow
{
    private const string RELATIVE_PATH = "Addressables/JsonData/Game/BagItem/fishTankDec.json";

    private List<FishTankDecData> decorationList = new List<FishTankDecData>();
    ...
    private readonly int[] categoryStartIds = { 0, 8001, 8201, 8401, 8601, 8801 };
    private readonly int[] categoryEndIds = { 0, 8199, 8399, 8599, 8799, 8999 };
    ...
    [MenuItem("Tools/游戏内容/2.物品内部数据(记得编辑通用数据)/8001_鱼缸装饰")]
    public static void ShowWindow()
    {
        var window = GetWindow<FishTankDecorationDataEditor>("鱼缸装饰编辑器");
    ...
    private void DrawTopToolbar()
    {
        ...
        EditorGUILayout.LabelField("🐠 鱼缸装饰编辑器 (ID: 8001-8999)", EditorStyles.boldLabel, GUILayout.Width(220));
    ...
    private List<FishTankDecData> GetFilteredList()
    {
    ...
    private void DrawDecorationItem(FishTankDecData item)
    {
    ...
    private FishTankDecData GetDecorationById(int id)
    {
    ...
    private void DrawEditMode()
    {
        ...
        int newCategoryIndex = EditorGUILayout.Popup(currentCategoryIndex, new string[] { "摆设", "挂饰", "边框", "底面", "背景" });
    ...
    private void SaveData()
    {
        ...
        var wrapper = new FishTankDecListWrapper { items = decorationList };
    ...
    private void QuickCreateDecoration()
    {
        ...
        var newItem = new FishTankDecData
        {
            id = newId,
            name = newName,
            description = "",
