    ...
    public class Benchmark01_UGUI : MonoBehaviour
    {
        ...
        IEnumerator Start()
        {
            ...
            if (BenchmarkType == 0) // TextMesh Pro Component
            {
                ...
                m_material02 = AssetManager.LoadFromResources<Material>("Fonts & Materials/LiberationSans SDF - BEVEL"); // Make sure the LiberationSans SDF exists before calling this...  
