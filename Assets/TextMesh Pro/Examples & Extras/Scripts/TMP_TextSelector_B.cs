...
namespace TMPro.Examples
{
    ...
    public class TMP_TextSelector_B : MonoBehaviour, IPointerEnterHandler, IPointerExitHandler, IPointerClickHandler, IPointerUpHandler
    {
        ...
        void LateUpdate()
        {
            if (isHoveringObject)
            {
                ...
                if (linkIndex != -1 && linkIndex != m_selectedLink)
                {
                    ...
                    // Z_Logger.Log("Link ID: \"" + linkInfo.GetLinkID() + "\"   Link Text: \"" + linkInfo.GetLinkText() + "\""); // Example of how to retrieve the Link ID and Link Text.
        ...
        {
            //Z_Logger.Log("Click at POS: " + eventData.position + "  World POS: " + eventData.worldPosition);
            ...
            if (charIndex != -1 && charIndex != m_lastIndex)
            {
                //Z_Logger.Log("Character [" + m_TextMeshPro.textInfo.characterInfo[index].character + "] was selected at POS: " + eventData.position);
                m_lastIndex = charIndex;
            ...
            */
            ...
            if (linkIndex != -1)
            {
                ...
                //Z_Logger.Log(TMP_TextUtilities.GetSimpleHashCode("id_02"));
